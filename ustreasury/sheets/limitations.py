...
from .. import common
from ..config import EXCLUDED, FUTURE_UPGRADES
...
def build(sh, ctx):
    ...
    r = common.explain_box(sh, 7, [
        "This model is intentionally simple: one plain US Treasury (fixed-coupon note/bond or zero-coupon bill). "
    ...
    common.explain_box(sh, r, [
        "For any of the above, use a dedicated fixed-income system. This tool is for understanding a single "
        "plain-vanilla US Treasury security.",
    ], last_col=LAST, title="In short")
