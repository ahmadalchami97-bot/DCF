"""Shared context + drawing / explanation / chart helpers for the Government Bond Analyzer."""
...
def interp(sh, row, lines, *, last_col, title="Explanation / Interpretation"):
    """An amber box placed just after a result."""
...
def cell_comment(sh, row, col, text):
    ...
    cm = Comment(text, "Government Bond Analyzer")
