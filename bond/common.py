"""Shared context + drawing / explanation / chart helpers for the Bond Analyzer."""
...
from .config import (APP_NAME, APP_VERSION, BAD_WORDS, GOOD_WORDS, Palette, WARN_WORDS)
